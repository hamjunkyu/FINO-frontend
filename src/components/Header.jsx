        ...
        <ul className="list-none m-0 p-0 flex
            ...
            <ul className="hidden absolute top-full left-0 bg-white shadow-lg rounded-8 py-dropdown-item-py list-none m-0 z-100 whitespace-nowrap min-w-[220px]
              ...
              <li className="group/dropdown-item">
                <a href="/design" className="flex items-center py-dropdown-item-py px-dropdown-item-px no-underline text-gray-700 text-15 transition-colors duration-200 hover:bg-gray-100 hover:text-brand-primary mobile-max:pl-mobile-dropdown-pl">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="pencil" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-[18px] h-[18px] mr-10px text-gray-500 group-hover/dropdown-item:text-brand-primary">
                  ...
                  <div className="Texts">
                    ...
                    <div className="text-12 text-gray-500"></div>
                  </div>
                </a>
              </li>
              <li className="group/dropdown-item">
                <a href="/database" className="flex items-center py-dropdown-item-py px-dropdown-item-px no-underline text-gray-700 text-15 transition-colors duration-200 hover:bg-gray-100 hover:text-brand-primary mobile-max:pl-mobile-dropdown-pl">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="database" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-[18px] h-[18px] mr-10px text-gray-500 group-hover/dropdown-item:text-brand-primary">
              ...
              <li className="group/dropdown-item">
                <a href="/logic" className="flex items-center py-dropdown-item-py px-dropdown-item-px no-underline text-gray-700 text-15 transition-colors duration-200 hover:bg-gray-100 hover:text-brand-primary mobile-max:pl-mobile-dropdown-pl">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bolt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="w-[18px] h-[18px] mr-10px text-gray-500 group-hover/dropdown-item:text-brand-primary">
              ...
              <li className="group/dropdown-item">
                <a href="/templates" className="flex items-center py-dropdown-item-py px-dropdown-item-px no-underline text-gray-700 text-15 transition-colors duration-200 hover:bg-gray-100 hover:text-brand-primary mobile-max:pl-mobile-dropdown-pl">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="copy" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-[18px] h-[18px] mr-10px text-gray-500 group-hover/dropdown-item:text-brand-primary">
          ...
          <li className="relative group desktop:w-auto mobile-max:w-full mobile-max:text-left">
            ...
            <ul className="hidden absolute top-full left-0 bg-white shadow-lg rounded-8 py-dropdown-item-py list-none m-0 z-100 whitespace-nowrap min-w-[220px]
                            ...
                            mobile-max:static mobile-max:shadow-none mobile-max:p-0 mobile-max:min-w-auto mobile-max:w-full mobile-max:rounded-none mobile-max:flex mobile-max:flex-col">
              <li>
                <div className="py-dropdown-item-py px-dropdown-item-px text-14 text-gray-600 font-bold cursor-default
                                 mobile-max:pl-mobile-dropdown-pl">
                  {t('customer_cases')}
                </div>
              </li>
              <li className="group/dropdown-item">
