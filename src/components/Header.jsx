        ...
        <ul className="list-none w-full flex justify-start m-0 flex-col items-start px-[16px] py-[10px] gap-nav-gap-mobile
          ...
          <li className="flex w-full justify-start items-center nav-list-item-padding 
            ...
            <a href="https://docs.waveon.io/ko" target="_blank" 
               className="inline-flex items-center no-underline text-gray-800 text-15 font-medium transition-colors duration-200 hover:text-brand-primary">
              {t('guides')}
              <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="up-right-from-square" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-3 h-3 ml-0.75 mb-0.25">
